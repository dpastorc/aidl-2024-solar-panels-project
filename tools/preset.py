...
#The result will be 4 zip files in result directory: PV01-split.zip, PV03-CROP-split.zip, PV-ALL-split.zip, GOOGLE-split.zip
...
os.makedirs(os.path.join(local_dir, "PV01-split"))
os.makedirs(os.path.join(local_dir, "PV03-CROP-split"))
os.makedirs(os.path.join(local_dir, "PV-ALL-split"))
os.makedirs(os.path.join(local_dir, "GOOGLE-split"))
os.makedirs(os.path.join(local_dir, "result"))
...
for item in dirs:
  input_file = os.path.join(os.path.join(local_dir, "PV03"), item)
  crop(input_file, os.path.join(local_dir, "PV03-CROP"), 16)
...
(train_images, train_masks), (val_images, val_masks), (test_images, test_masks) = split_dataset(os.path.join(local_dir, "PV03-CROP/img"),
                                                                                                os.path.join(local_dir, "PV03-CROP/mask"))
...
(train_images, train_masks), (val_images, val_masks), (test_images, test_masks) = split_dataset(os.path.join(local_dir, "bdappv/google/img"),
                                                                                                os.path.join(local_dir, "bdappv/google/mask"))
